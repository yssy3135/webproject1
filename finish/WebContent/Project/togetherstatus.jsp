...
<%
 /* 페이징 처리 */
	...
	*/
	...
	// 현재 페이지 - 레코드 시작번호
	int startNo = (currentPage-1)*recordBypage; 
	...
	<div class="togethercontainer">
		<div class="togethermain">
			...
			<table class="tab">
				...
				ArrayList<TogetherVO> list = dao.status(status);
		...
		<tr>
			<td colspan="7" id = "page">
				...
				%>
				<a class = "pagedetail" id = <%=i %> href="togetherstatus.jsp?cp=<%=i %>"><span><%=i %></span></a>
				<%
						} // if end
		...
		<div class="bot">
			...
			<a href=""><input type="button" value="검색"  class = "search"/></a>
			<input type="text" name="" id="txt" class = "search"/>
