...
<%-- <%if(memno != null){
	...
	%> --%>
	     	<div class="login">
	     		<ul>
	     			<li><a href="../teamproject2/logOut.jsp">님 로그아웃</a>
	     			<span></span>
	     			</li>
	     			<li><a href="../teamproject/main.jsp?fno=../teamproject2/myPage.jsp">마이페이지</a>
	     			<span></span>
	     			</li>
	     			<li><a href="../teamproject/main.jsp?fno=../teamproject/MainBoard/MainBoard.jsp">고객센터</a>
	     			<span></span>
	     			</li>
	     		</ul>
	     	</div>
...
%> --%>
	<div class="login">
		<ul>
			<li><a href="../teamproject/main.jsp?fno=../teamproject2/login.jsp">로그인</a>
			<span></span>
			</li>
			<li><a href="../teamproject/main.jsp?fno=../teamproject2/register.jsp">회원가입</a>
			<span></span>
			</li>
			<li><a href="../teamproject/main.jsp?fno=../teamproject2/login.jsp">마이페이지</a>
			<span></span>
			</li>
			<li><a href="../teamproject/main.jsp?fno=../teamproject/MainBoard/MainBoard.jsp">고객센터</a>
			<span></span>
...
%> --%>
	...
	<div id="headerdetail">
		<div id="logo">
			<a href="../teamproject/main.jsp"><img src="../teamProimage/logo1.png" alt=""/></a>
		</div>
		<div id="search">
			<form name="frm">
