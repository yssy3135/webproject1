...
<body>
	...
	%>
			<li>
				<a href="../teamproject/main.jsp?fno=productDetail.jsp?pno=<%=tvo.getPno()%>">
					<img src="<%=tvo.getMainimg()%>" alt="" class="bestimg" />
				</a>
				<div id="capp">
					<p class="capp1">[<%=tvo.getTema() %>]</p>
					<p class="capp2"><%=tvo.getPcontents() %></p>
					<p class="capp3"><%=tvo.getPname() %></p>
				</div>
			</li>
	<%
		}
