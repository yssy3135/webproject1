...
<%
 ...
 /* 페이징 처리 */
	...
	//총게시글 수
	int totalCount = dao.searchCount(word);
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#refresh").on('click',function(){
			document.location = "freeboard.jsp";
		});
	...
	<div class="main">
		<div class="container">
			...
			<table class="tab">
				...
				ArrayList<freeboardVO> list = dao.search(word, startNo, endNo);
		...
		<tr>
			<td colspan="6" id = "page">
				...
				%>
				<a class = "pagedetail" id = <%=i %> href="freeboardsearch.jsp?word=<%=word2%>&cp=<%=i %>"><span><%=i %></span></a>
				<%
						} // if end
			...
			<div class="bot">
				...
				<input type="button" id = "refresh" value="초기화" />
